...
with bodyContainer:
    ...
    with CostofLiving:
        ...
        # Add content for the Buying Power Overview tab here
            ...
            with right:
                st.write("Enter the information of your preferred destination")
                selectedRegioncalculatordestination = st.selectbox("Select Region of preferred destination", ["Europe", "Asia", "America", "Africa", "Oceania"], key="selectregiondestination")
                listofcountries2 = EXP.getLivingExpenses(year, selectedRegioncalculatordestination).iloc[1:, 1].tolist()
                destination = st.selectbox("Please provide your preferred destination", listofcountries2)
            with left:    
                totalamount = int(st.number_input("Put in your total spendings"))
                rentamount = int(st.number_input("Put in your rent spendings"))
                grocamount = int(st.number_input("Put in your grocery spendings"))
